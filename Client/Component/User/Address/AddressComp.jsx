                        ...
                        <div className="AddressCard">
                          <div className="row">
                            <div className="col-10">
                              <div>
                                <h6 className="font-bold text-small">
                                  {obj.name} {obj.number}
                                </h6>
                              </div>
                              <div>
                                <p className="text-small mb-1">
                                  {obj.address}, {obj.locality}, {obj.city}
                                </p>
                                <p className="text-small mb-1">
                                  {obj.state} -{" "}
                                  <span className="font-bold">{obj.pin}</span>
                                </p>
                              </div>
                            </div>
                            <div className="col-2">
                              <div className="dropdown">
                                ...
                                <ul className="dropdown-menu">
                                  <li>
                                    <a
                                      className="dropdown-item text-small UserBlackMain"
                                      type="button"
                                      data-bs-toggle="modal"
                                      data-bs-target="#addressModal"
                                      onClick={() => {
