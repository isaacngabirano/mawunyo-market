    ...
    <>
      {products.length !== 0 ? (
        <div className="CartComp">
                  ...
                  return (
                    <div className="cartCard" key={key}>
                      <div className="imgDiv">
                        <img
                          src={`${ServerId}/product/${obj.item.uni_id_1}${obj.item.uni_id_2}/${obj.item.files[0].filename}`}
                          alt={obj.item.name}
                        />
                      </div>

                      <div className="content">
                        <h4 className="font-bold UserBlackMain oneLineTxt-Desk-Specific">
                          {obj.item.name}
                        </h4>
                        <h6 className="font-bold">
                          <span className="UserGrayMain">
                            <small>
                              <del>sh {obj.mrp}&nbsp;</del>
                            </small>
                          </span>
                          &nbsp;&nbsp;
                          <span className="UserBlackMain">sh {obj.price}</span>
                        </h6>
                              ...
                              <button
                                ...
                                onClick={() => {
                                  if (obj.quantity - 1 === 0) {
                                    if (
                                      window.confirm(
                                        `Do you want remove ${obj.item.name}`
                                      )
                                    ) {
                                      userAxios((server) => {
                                        server
                                          .put("/users/removeItemCart", {
                                            proId: obj.item._id,
                                          })
                                          .then((res) => {
                                            if (res.data.login) {
                ...
                <div className="cartAmtCard">
                  ...
                  <div className="subDiv">
                    <div className="AmtDiv">
                      ...
                      <div>
                        <p>sh {amount.totalPrice}</p>
                        <p>sh {amount.totalDiscount}</p>
                        <p>sh {amount.totalMrp}</p>
                        <h6 className="font-bold">sh {amount.totalPrice}</h6>
                      </div>
                    </div>
                  </div>
                    ...
                    return (
                      <div className="col-12" key={key}>
                        <div className="cartCard">
                          ...
                          <div className="content">
                            <h4 className="font-bold UserBlackMain oneLineTxt-Mob">
                              {obj.item.name}
                            </h4>
                            <h6 className="font-bold">
                              <span className="UserGrayMain">
          ...
          <div
            style={{ display: showOrdrBtn ? "block" : "none" }}
            className="amtCardFixed"
          >
            <div className="container">
              <div className="MainDiv">
                <div>
                  <h6 className="font-bold UserGrayMain">
                    <small>
                      <del>sh {amount.totalMrp}</del>
                    </small>
                  </h6>
                  <h6 className="font-bold UserBlackMain">
                    sh {amount.totalPrice}
                  </h6>
                </div>
