...
function Header() {
  ...
  const { userLogged, setUserLogged, LoginModal, setLoginModal, cartTotal } =
  ...
  useEffect(() => {
    Server.get("/users/getHeaderCategories")
      .then((categories) => {
              ...
              <div className="row">
                <div className="col-3 pt-2">
                  <Link className="LinkTagNonDec" href="/">
                    <h5 className="UserGreenMain">Mawunyo Market</h5>
                  </Link>
                </div>
                <div className="col-5">
                  <div>
                      ...
                      <div className="GridTwoAuto">
                        ...
                        <div>
                          ...
                          {userLogged.status ? (
                            <h6
                              className={
                                style.accNameMax + " text-small UserBlackMain"
                              }
                              style={{ cursor: "pointer" }}
                              onClick={() => {
                                navigate.push("/account");
                        ...
                        <div>
                          {userLogged.status ? (
                            <>
                              ...
                              <h6
                                className="text-small UserBlackMain"
                                style={{ cursor: "pointer" }}
                                onClick={() => {
                                  navigate.push("/cart");
                                }}
          ...
          <div className={style.sub}>
            <div className="container">
              <div>
                <ul>
                  <li>
                    <Link className={style.mainLink} href={"/"}>
                      Home
                    </Link>
                  </li>
                  <li>
              ...
              <div className="row">
                <div className="col-12">
                  <h5 className="text-small">
                    ...
                    &nbsp;&nbsp;
                    <span className="font-normal UserGrayMain">
