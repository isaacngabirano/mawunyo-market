...
function HomePost({ layout }) {
  ...
  const { setQuickVw, QuickVw, setUserLogged, setLoginModal, setCartTotal } =
  ...
  return (
    <div className={style.HomePost}>
                  ...
                  return (
                    <SwiperSlide key={key}>
                      <div className={style.UserMainProCard}>
                        <div
                          className={style.UserMainProimgDiv + " text-center"}
                        >
                          <div>
                            <button className={style.offerGreen}>
                              {obj.discount}%
                            </button>
                            {obj.available === "true" ? (
                              <button
                          ...
                          <button
                            ...
                            onClick={() => {
                              Server.get(
                                "/users/product/" + obj.slug + "/" + obj._id
                              )
                                .then((item) => {
                                  setQuickVw({
                                    ...QuickVw,
                        ...
                        >
                          <div className="pt-2">
                            ...
                            <h6 className="UserBlackMain oneLineTxt">
                              {obj.name}
                            </h6>
                            <h6>
      ...
      {banner && banner.file && banner.file.length !== 0 && (
        <div className="UserMainBgGrey">
                          ...
                          <div className={style.usrLastHmGrid}>
                            ...
                            <div className="p-2">
                              <h6
                                className={
                                  style.category +
                                  " UserGrayMain text-small oneLineTxt"
                                }
                              >
                                <small>{obj.category}</small>
                              </h6>
                              <h6
                                className={
                                  style.proName + " UserBlackMain oneLineTxt"
                                }
                              >
                                {obj.name}
                              </h6>
