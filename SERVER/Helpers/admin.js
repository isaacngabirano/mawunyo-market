...
export default {
  ...
  editOrder: (
    { order_id_shiprocket, shipment_id, OrderStatus, userId, secretOrderId },
    updated
  ) => {
  ...
  getDashboardTotal: () => {
    return new Promise(async (resolve, reject) => {
      ...
      if (
        Array.isArray(totalDelivered) &&
        Array.isArray(totalReturn) &&
        Array.isArray(totalCancelled) &&
